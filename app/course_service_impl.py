...
class CourseServiceImpl(CourseService):
  ...
  def get_assignments_by_course_id(self, course_id) -> List[Assignment]:
    """
  ...
  def dropout_student(self, course_id, student_id):
    ...
    """
    #delete the assignment grades too
    course = self.get_course_by_id(course_id)
  ...
  def create_student(self, student_name) -> Course:
    """
  ...
  def delete_student(self, student_id) -> Course:
    """
    Deletes a course by its id.
    """
    student = self.get_student_by_id(student_id)
  ...
  ### Helper functions
  def is_student_enrolled(self, course_id, student_id):
    course = self.get_course_by_id(course_id)
    return student_id in course.students_enrolled